...
{
    /// <summary>
    /// ДТО ответа API, возвращающий данные карточки жалобы с измененныым статусом.
    /// </summary>
    /// <param name="Id">Уникальный идентификатор карточки жалобы, сгенерированный базой данных.</param>
