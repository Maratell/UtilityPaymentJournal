...
{
    /// <summary>
    /// Запрос на создание показания счетчика воды.
    /// </summary>
    ...
    public record CreateWaterReadingRequest(
        long? ResidenceId,
    ...
    {
        public CreateWaterReadingCommand ToCommand() =>
            new CreateWaterReadingCommand(
                ResidenceId,
                UtilityProviderId,
                WaterType,
                SubmissionDate,
