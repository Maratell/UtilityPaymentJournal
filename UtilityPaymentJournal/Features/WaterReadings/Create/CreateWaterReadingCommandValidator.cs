...
{
    public class CreateWaterReadingCommandValidator : AbstractValidator<CreateWaterReadingCommand>
    {
        public CreateWaterReadingCommandValidator()
        {
            ...
            RuleFor(x => x.WaterType)
                .IsInEnum().WithMessage("Выбран некорректный тип ресурса");
