...
{
    /// <summary>
    /// Запрос на редактировании показания счетчика электроэнергии.
    /// </summary>
    ...
    public record EditElectricityReadingRequest(
        long? ResidenceId,
    ...
    {
        public EditElectricityReadingCommand ToCommand(long id) =>
            new EditElectricityReadingCommand(
                id, 
                ResidenceId, 
                UtilityProviderId, 
                SubmissionDate, 
