...
{
    public class CreateElectricityReadingCommandValidator : AbstractValidator<CreateElectricityReadingCommand>
    {
        public CreateElectricityReadingCommandValidator()
        {
