...
{
    /// <summary>
    /// ДТО результата запроса данных показаний счетчика электроэнергии.
    /// Используется для передачи полной информации клиенту в UI (GetById/GetAll).
    /// </summary>
    /// <param name="Id">Идентификатор записи показания счетчика электроэнергии</param>
    ...
    public record ElectricityReadingQueryResultDto(
    long Id,
    long? ResidenceId,
