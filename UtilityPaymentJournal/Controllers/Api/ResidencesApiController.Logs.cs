...
namespace UtilityPaymentJournal.Controllers.Api
{
    public partial class ResidencesApiController
    {
        ...
        [LoggerMessage(EventId = 1009, Level = LogLevel.Information, Message = "Запрос на обновление жилого объекта. ID записи: {id}. Новый адрес: {address}")]
        private static partial void LogResidenceUpdateRequested(ILogger<ResidencesApiController> logger, long id, string address);

        [LoggerMessage(EventId = 1010, Level = LogLevel.Information, Message = "Запрос на удаление жилого объекта. ID записи: {id}")]
        ...
        [LoggerMessage(EventId = 1002, Level = LogLevel.Information, Message = "Создан жилой объект. Записи присвоен ID: {id}")]
        private static partial void LogResidenceCreated(ILogger<ResidencesApiController> logger, long id);

        [LoggerMessage(EventId = 1003, Level = LogLevel.Information, Message = "Успешно обновлен жилой объект с ID: {id}")]
        ...
        [LoggerMessage(EventId = 1005, Level = LogLevel.Debug, Message = "Получено {count} жилых объектов для отображения")]
