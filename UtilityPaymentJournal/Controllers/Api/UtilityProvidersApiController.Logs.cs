namespace UtilityPaymentJournal.Controllers.Api
{
    public partial class UtilityProvidersApiController
    {
        ...
        [LoggerMessage(EventId = 4008, Level = LogLevel.Information, Message = "Запрос на создание поставщика услуг. Название: {name}")]
        private static partial void LogUtilityProviderCreationRequested(ILogger<UtilityProvidersApiController> logger, string name);

        [LoggerMessage(EventId = 4009, Level = LogLevel.Information, Message = "Запрос на обновление поставщика услуг {id}. Новое название: {name}")]
        ...
        [LoggerMessage(EventId = 4010, Level = LogLevel.Information, Message = "Запрос на удаление поставщика услуг {id}")]
        ...
        [LoggerMessage(EventId = 4001, Level = LogLevel.Information, Message = "Поставщик услуг {id} удален из системы")]
        private static partial void LogUtilityProviderDeleted(ILogger<UtilityProvidersApiController> logger, long id);

        [LoggerMessage(EventId = 4002, Level = LogLevel.Information, Message = "Создан поставщик услуг {id}")]
        private static partial void LogUtilityProviderCreated(ILogger<UtilityProvidersApiController> logger, long id);

        [LoggerMessage(EventId = 4003, Level = LogLevel.Information, Message = "Обновлен поставщик услуг {id}")]
        ...
        [LoggerMessage(EventId = 4004, Level = LogLevel.Debug, Message = "Запрос на получение списка всех поставщиков услуг")]
        private static partial void LogFetchingAllUtilityProviders(ILogger<UtilityProvidersApiController> logger);

        [LoggerMessage(EventId = 4005, Level = LogLevel.Debug, Message = "Извлечено {count} поставщиков услуг для отображения")]
